...
public class EscolhaPoltronaCinema {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < salaCinema.length; i++) { //Linhas
            for (int j = 0; j < salaCinema[i].length; j++) { //Colunas
                System.out.print(salaCinema[i][j] == 0 ? "L " : "O "); // Ternário para substituir o 0 e 1 por L e O
            }
